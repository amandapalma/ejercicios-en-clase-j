...
const handleElementClick = ev => {
  console.log(
    `El elemento pulsado es ${ev.target.tagName} y el escuchado es ${ev.currentTarget.tagName}`
  );
  ev.preventDefault();
};
...
// es decir, los listeners NO se ejecutan en el orden en el que declaran en el cógido
